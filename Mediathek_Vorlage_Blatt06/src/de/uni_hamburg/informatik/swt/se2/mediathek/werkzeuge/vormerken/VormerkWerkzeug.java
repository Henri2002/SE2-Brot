...
public class VormerkWerkzeug
{
    ...
    private boolean istVormerkenMoeglich()
    {
        ...
        //Hier noch sicherstellen, dass Kunden die bereits auf Liste stehen nicht mehr Vormerken können
        for (Medium medium : medien)
        {
            if (_verleihService.getVormerkkarte(medium)
                .pruefeObKundeEnthalten(kunde)
                    || _verleihService.getVormerkkarte(medium)
                        .getSize() == 3)
            {
